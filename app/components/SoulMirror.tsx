      ...
      <AnimatePresence mode="wait">
        ...
        {phase === 'voice' && (
          <motion.div key="voice" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.4 }}
            ...
            <GoldLines />
            <SectionHeader step="Soul Mirror · Step 1 of 5"
        ...
        {phase === 'style' && (
          <motion.div key="style" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.4 }}
            ...
            <GoldLines />
            <SectionHeader step="Soul Mirror · Step 2 of 5" title="Choose your avatar style" sub="This shapes how your Soul Mirror portrait is designed." />
        ...
        {phase === 'hubstyle' && (
          <motion.div key="hubstyle" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.4 }}
            style={{ ...cardStyle, width: 'min(720px, 95vw)', padding: 'clamp(28px,5vw,44px)' }}>
            <GoldLines />
            <SectionHeader step="Soul Mirror · Step 3 of 5" title="How does your hub appear in the universe?" sub="Each structure has its own animation and personality. Others see this when they explore the map." />
